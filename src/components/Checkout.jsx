          ...
          <div className="w-full flex justify-start pb-[40px] border-b-[1px] border-[#d2d2d7]">
            <div className="w-[50%]">
              <button
                required
                type="checkbox"
                className="border-[1px] flex justify-between items-center peer appearance-none focus:border-[2px] focus:border-[#06c] border-gray-600 w-[490px] h-[83px] rounded-[12px]"
              >
            ...
            <div className="flex flex-col justify-center pl-5">
              ...
              <ul className="mt-1">
                ...
                <li className="list-disc ms-[15px] text-[14px] mt-1">
                  In-Transit Options: Once your order has <br /> been shipped,
                  you can use your tracking <br /> link to redirect your
                  shipment to a pickup <br /> point, hold it at a secure
                  location, or fill out <br /> a signature waiver or shipment
                  release.
                </li>
              </ul>
