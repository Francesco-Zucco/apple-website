      ...
      <div>
        ...
        {responsivePhoto ? (
          <div className="grid grid-cols-1  gap-3 pt-3">
            ...
            <div className="relative flex justify-center w-auto h-[500px]">
              <div className="absolute z-10 flex items-center text-center bottom-0 pb-[100px] text-[32px] font-semibold ">
                {" "}
                <svg
                  fill="#000000"
                  height="88"
          ...
          <div className="grid grid-cols-2 grid-rows-3 gap-3 m-3">
            ...
            <div className="relative flex justify-center">
              ...
              <p className="absolute z-10 text-[18px] text-semibold text-center bottom-0 pb-[76px]">
            ...
            <div className="relative flex justify-center">
              <div className="absolute z-10  flex flex-col items-center pt-10">
                <div className="flex items-center text-[40px] h-12 font-medium">
                  <svg
                    fill="#000000"
                    height="88"
                    viewBox="0 0 14 44"
