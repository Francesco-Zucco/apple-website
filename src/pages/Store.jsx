...
const Store = () => {
  ...
  return (
    <>
      <div className="bg-[#f5f5f7] flex flex-col overflow-hidden	 items-center w-full">
        {pageWidth ? (
        ...
        <div className=" w-full flex content-start justify-center ml-10 ">
          <Carousel
          ...
          >
            <Link to={"/mac"}>
              <div className="w-[136px] select-none flex flex-col items-center gap-2 h-[148px]">
                <img
                  className="select-none"
                  src="images\store_photos\store-card-mac.png"
                  alt=""
                />
                <p>Mac</p>
              </div>
            ...
            <Link to={"/iphones"}>
              <div className="w-[136px] select-none flex flex-col items-center gap-2 h-[148px]">
                <img src="images\store_photos\store-card-iphone.png" alt="" />
                <p>iPhone</p>
              </div>
            </Link>
            <Link to={"/ipads"}>
              <div className="w-[136px] select-none flex flex-col items-center gap-2 h-[148px]">
                <img src="images\store_photos\store-card-ipad.png" alt="" />
                <p>iPad</p>
              </div>
            </Link>
            <Link to={"/watches"}>
              <div className="w-[136px] select-none flex flex-col items-center gap-2 h-[148px]">
                <img src="images\store_photos\store-card-watch.png" alt="" />
                <p>Apple Watch</p>
              </div>
            </Link>
            <Link to={"/vision"}>
              <div className="w-[136px] select-none flex flex-col items-center gap-2 h-[148px]">
                <img src="images\store_photos\store-card-vision.png" alt="" />
                <p>Apple Vision Pro</p>
              </div>
            </Link>
            <Link to={"/airpods"}>
              <div className="w-[136px] select-none flex flex-col items-center gap-2 h-[148px]">
                <img src="images\store_photos\store-card-airpods.png" alt="" />
                <p>AirPods</p>
              </div>
            </Link>
            <Link to={"/tv-home"}>
              <div className="w-[136px] select-none flex flex-col items-center gap-2 h-[148px]">
                <img src="images\store_photos\store-card-appletv.png" alt="" />
                <p>Apple TV 4k</p>
              </div>
            </Link>
            <Link to={"/tv-home"}>
              <div className="w-[136px] select-none flex flex-col items-center gap-2 h-[148px]">
                <img src="images\store_photos\store-card-homepod.png" alt="" />
                <p>HomePod</p>
              </div>
            </Link>
            <Link to={"/accessories"}>
              <div className="w-[136px] select-none flex flex-col items-center gap-2 h-[148px]">
                <img
                  src="images\store_photos\store-card-accessories.png"
                  alt=""
                />
                <p>Accessories</p>
              </div>
